...
export const FilterBar: React.FC<FilterBarProps> = ({
  ...
  return (
    <section
      ...
      className="bg-slate-900 border border-slate-800 rounded-2xl p-2.5 sm:p-3 shadow-sm font-mono"
    >
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
        ...
        <div className="flex items-center justify-between sm:justify-start gap-2 shrink-0">
          ...
          {hasActiveFilters && (
            <button
              ...
              className="sm:hidden text-xs text-slate-300 hover:text-sky-400 flex items-center gap-1 px-3 py-1.5 rounded-full bg-slate-800 border border-slate-700 transition-colors cursor-pointer active:scale-95 whitespace-nowrap"
            >
        ...
        {hasActiveFilters && (
          <button
            ...
            type="button"
            onClick={onResetFilters}
            className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs text-slate-300 hover:text-sky-300 bg-slate-800 hover:bg-slate-750 border border-slate-700 transition-colors cursor-pointer active:scale-95 whitespace-nowrap shrink-0"
          >
